...
public class MapMethodDepo {
    ...
    public static void bolumListesiOlusturma(Map<Integer, String> ogrenciMap, String bolumListesi) {
        ...
        for (Map.Entry<Integer, String> eachEntry : entrySeti
            ...
            if (valueArr[4].equalsIgnoreCase(bolumListesi)) {
                System.out.println(eachEntry.getKey() + " " +
                        valueArr[1] + " " +
                        valueArr[2] + " " +
                        valueArr[3] + " ");
    ...
    public static void tumListeOlustur(Map<Integer, String> ogrenciMap) {
